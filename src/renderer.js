...
class KroppieApp {
    ...
    async cropAndSave() {
        if (!this.state.currentImage || !this.state.outputDirectory) return;
        ...
        try {
            ...
            canvas.toBlob(async (blob) => {
                ...
                const outputPath = await window.electronAPI.joinPath(this.state.outputDirectory, this.state.currentImage.name);
    ...
    updateUI() {
        ...
        // Update crop button
        this.elements.cropSaveBtn.disabled = !this.state.currentImage || !this.state.outputDirectory;
